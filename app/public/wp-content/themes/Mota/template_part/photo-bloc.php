<?php
    ...
    // Récupération du format de la photo et stockage pour filt
    ...
    // Récupération de la catégorie de la photo et stockage pou
...
<div class="...">
    ...
    <div class="...">
        <div class="...">
            <div class="...">
                <i class="fa-solid fa-expand full-screen" style
            </div>
            <div class="...">
                <i class="fa-regular fa-eye oeil" style="color:
            </div>
            <div class="...">
                <div class="...">
